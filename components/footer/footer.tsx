        ...
        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          <li>
            ...
            >
              ...
              <svg className="h-6 w-6" fill="orange" viewBox="0 0 24 24" aria-hidden="true">
                <path
                  fillRule="evenodd"
    ...
    <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        <p className="text-sm text-gray-500">
          ...
          <a
            className="inline-block text-yellow-400 underline transition hover:text-teal-600/75"
            href="#"
          >
            Terms & Conditions
          </a>
        ...
        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2024 ISTAD STUDENT</p>
      </div>
    </div>
  </div>
</footer>
